...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var comp1 = other1.elements;
        var comp2 = other2.elements;
        var x3 = comp1[1] * comp2[2] - comp1[2] * comp2[1];
        var y3 = comp1[2] * comp2[0] - comp1[0] * comp2[2];
        var z3 = comp1[0] * comp2[1] - comp1[1] * comp2[0];
